...
def main():
    ...
    while True:
        packed_data = ser.read(16)

        unpacked_data = struct.unpack('<8h', packed_data)
        ...
        if unpacked_data[0] == -21846:
            ...
            unpacked_data = struct.unpack('<4f', packed_data)
            print("Accel: ", unpacked_data[1], unpacked_data[2], unpacked_data[3])
        # else:
        #     print("Nekaj narobe!")
        #     print(head)
        #     return 0
